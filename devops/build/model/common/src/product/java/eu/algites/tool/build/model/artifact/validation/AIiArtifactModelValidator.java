 ...
 * 		    If {@link AInArtifactDependencyScopeLevel#IMPORT} is used, then {@link AIiArtifactOutput#getOutputPackagingId()} must be {@code "pom"}.</li>
 *
 ...
 * 		    If {@link AInArtifactDependencyScopeLevel#IMPORT} is used, then {@link AIiArtifactOutput#getOutputClassifier()} should be empty/null.
