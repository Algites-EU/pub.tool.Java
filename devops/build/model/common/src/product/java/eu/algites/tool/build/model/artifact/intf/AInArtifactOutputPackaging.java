...
public enum AInArtifactOutputPackaging {
	...
	/**
	 * finds the packaging from the code
	 * @param aOutputPackagingCode code of the packaging
	 ...
	 */
	public static AInArtifactOutputPackaging fromOutputPackagingCode(String aOutputPackagingCode) {
