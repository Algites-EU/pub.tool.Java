...
import eu.algites.pltf.knitstro.structure.artifacts.model.loader.AIcArtifactModelLoadContainer;
...
/**
 * <p>
 * Title: {@link AIcArtifactLoadContainerLateInitializationValidator}
 * </p>
 * <p>
 ...
 * @date 16.01.26 8:48
 */
class AIcArtifactLoadContainerLateInitializationValidator<A extends AIiAbstractArtifact>
		implements AIiLateInitializationMapInsertValidator<String, AIcArtifactModelLoadContainer<A>> {

	@Override
	public boolean validateInsert(
			final AIcLateInitializationMap<String, AIcArtifactModelLoadContainer<A>> aMap,
			final String aKey,
			final AIcLateInitializationSlot<AIcArtifactModelLoadContainer<A>> aSlot,
			final AIcArtifactModelLoadContainer<A> aNewValue) {

		AIcLateInitializationSlot<AIcArtifactModelLoadContainer<A>> locSlot = aMap.getOrDeclareSlot(aKey);
