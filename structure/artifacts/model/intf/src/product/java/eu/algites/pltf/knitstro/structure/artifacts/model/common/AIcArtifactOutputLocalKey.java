...
import eu.algites.pltf.knitstro.structure.artifacts.model.utils.AIsComponentUtils;
...
public final class AIcArtifactOutputLocalKey implements AIiArtifactOutputType {
	...
	public static AIiArtifactOutputType newKey(@Nonnull final String aOutputTypeUid) {
		AIiArtifactOutputTypeDataUidRecord locRecord = AIsComponentUtils.parseUid(aOutputTypeUid);
