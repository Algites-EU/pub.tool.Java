 ...
 * @author linhart1
 */
public record AIrExportModeDataUidRecord(
		String uid,
		AInUidEnumDataOrigin origin,
		String namespace,
		String modeCode
) implements AIiExportModeDataUidRecord {

	static {
		AIiExportModeDataUidRecord.staticValidation();
	}
	 ...
	 * @return the factory
	 */
	public static BiFunction<String, List<String>, AIrExportModeDataUidRecord> getUidRecordFactory() {
		return (aUid, aParts) -> {
			AInUidEnumDataOrigin locOrigin = AInUidEnumDataOrigin.getByCodeOrThrow(aParts.get(ORIGIN_UID_POSITION));
			return new AIrExportModeDataUidRecord(aUid,
					locOrigin,
