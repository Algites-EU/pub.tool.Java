...
/**
 * <p>
 * Title: {@link AIiSetDataInheritanceModeDataUidRecord}
 * </p>
 * <p>
 ...
 * @date 16.01.26 14:34
 */
public interface AIiSetDataInheritanceModeDataUidRecord extends AIiUidEnumDataRecord, AIiEnumItem {

	@AIaFieldLabel(label = "set-inheritance-mode-uid")
	@Override
	String uid();

	@AIaFieldLabel(label = "set-inheritance-mode-origin")
	@Override
	AInUidEnumDataOrigin origin();

	@AIaFieldLabel(label = "set-inheritance-mode-namespace")
	@Override
	String namespace();
	 ...
	 * @return the modeCode
	 */
	@AIaFieldLabel(label = "set-inheritance-mode-code")
	String modeCode();
	...
	List<AIiUidPartMetadata<AInUidEnumDataOrigin>> RECORD_SPECIFIC_PARTS_METADATA = List.of(
			new AIrUidPartMetadata(() -> AIsFieldLabelUtils.findLabel(
					AIiSetDataInheritanceModeDataUidRecord.class,
	...
	static void staticValidation() {
		AIsFieldLabelUtils.requirePropertyExists(
				AIiSetDataInheritanceModeDataUidRecord.class, MODE_CODE_FIELD_NAME);
	}
