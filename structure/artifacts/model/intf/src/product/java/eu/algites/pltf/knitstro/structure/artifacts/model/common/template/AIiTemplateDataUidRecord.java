...
/**
 * <p>
 * Title: {@link AIiTemplateDataUidRecord}
 * </p>
 * <p>
 ...
 * @date 16.01.26 14:34
 */
public interface AIiTemplateDataUidRecord extends AIiUidEnumDataRecord, AIiEnumItem {

	@AIaFieldLabel(label = "template-uid")
	@Override
	String uid();

	@AIaFieldLabel(label = "template-origin")
	@Override
	AInUidEnumDataOrigin origin();

	@AIaFieldLabel(label = "template-namespace")
	@Override
	String namespace();
	 ...
	 */
	@AIaFieldLabel(label = "template-code")
	String templateCode();
	...
	List<AIiUidPartMetadata<AInUidEnumDataOrigin>> RECORD_SPECIFIC_PARTS_METADATA = List.of(
			new AIrUidPartMetadata(() -> AIsFieldLabelUtils.findLabel(
					AIiTemplateDataUidRecord.class,
