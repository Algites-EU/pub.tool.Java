...
/**
 * <p>
 * Title: {@link AIiExportModeDataUidRecord}
 * </p>
 * <p>
 ...
 * @date 16.01.26 14:34
 */
public interface AIiExportModeDataUidRecord extends AIiUidEnumDataRecord, AIiEnumItem {

	@AIaFieldLabel(label = "export-mode-uid")
	@Override
	String uid();

	@AIaFieldLabel(label = "export-mode-origin")
	@Override
	AInUidEnumDataOrigin origin();

	@AIaFieldLabel(label = "export-mode-namespace")
	@Override
	String namespace();
	 ...
	 * @return the modeCode
	 */
	@AIaFieldLabel(label = "export-mode-code")
	String modeCode();
	...
	List<AIiUidPartMetadata<AInUidEnumDataOrigin>> RECORD_SPECIFIC_PARTS_METADATA = List.of(
			new AIrUidPartMetadata(() -> AIsFieldLabelUtils.findLabel(
					AIiExportModeDataUidRecord.class,
	...
	static void staticValidation() {
		AIsFieldLabelUtils.requirePropertyExists(
				AIiExportModeDataUidRecord.class, MODE_CODE_FIELD_NAME);
	}
