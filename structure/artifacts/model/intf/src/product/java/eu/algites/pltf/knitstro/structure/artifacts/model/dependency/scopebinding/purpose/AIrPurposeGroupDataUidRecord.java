...
/**
 * Parsed representation of the Purpose Group UID.
 *
 ...
 * @author linhart1
 */
public record AIrPurposeGroupDataUidRecord(
		String uid,
		AInUidEnumDataOrigin origin,
		String namespace,
		String groupCode
) implements AIiPurposeGroupDataUidRecord {

	static {
		AIiPurposeGroupDataUidRecord.staticValidation();
	}
	 ...
	 * @return the factory
	 */
	public static BiFunction<String, List<String>, AIrPurposeGroupDataUidRecord> getUidRecordFactory() {
		return (aUid, aParts) -> {
			AInUidEnumDataOrigin locOrigin = AInUidEnumDataOrigin.getByCodeOrThrow(aParts.get(ORIGIN_UID_POSITION));
			return new AIrPurposeGroupDataUidRecord(aUid,
					locOrigin,
