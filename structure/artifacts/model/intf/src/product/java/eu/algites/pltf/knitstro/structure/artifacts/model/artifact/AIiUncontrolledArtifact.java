...
import static eu.algites.pltf.knitstro.structure.artifacts.model.utils.AIsModelUtils.UNSPECIFIED_VERSION_PLACEHOLDER;
...
public interface AIiUncontrolledArtifact extends AIiAbstractVersionedMultiOutputArtifact, AIiAbstractDefinedArtifact {
	 ...
	 * then returns the {@link AIsModelUtils#UNSPECIFIED_VERSION_PLACEHOLDER}
