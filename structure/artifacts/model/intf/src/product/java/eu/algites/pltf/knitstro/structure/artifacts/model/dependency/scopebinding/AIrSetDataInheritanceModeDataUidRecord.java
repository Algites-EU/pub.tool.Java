...
/**
 * Parsed representation of the inheritance modes UID.
 *
 ...
 * @author linhart1
 */
public record AIrSetDataInheritanceModeDataUidRecord(
		String uid,
		AInUidEnumDataOrigin origin,
		String namespace,
		String modeCode
) implements AIiSetDataInheritanceModeDataUidRecord {

	static {
		AIiSetDataInheritanceModeDataUidRecord.staticValidation();
	}
	 ...
	 * @return the factory
	 */
	public static BiFunction<String, List<String>, AIrSetDataInheritanceModeDataUidRecord> getUidRecordFactory() {
		return (aUid, aParts) -> {
			AInUidEnumDataOrigin locOrigin = AInUidEnumDataOrigin.getByCodeOrThrow(aParts.get(ORIGIN_UID_POSITION));
			return new AIrSetDataInheritanceModeDataUidRecord(aUid,
					locOrigin,
